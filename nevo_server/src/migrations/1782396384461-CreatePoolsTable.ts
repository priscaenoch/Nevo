...
export class CreatePoolsTable1782396384461 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."pools_status_enum" AS ENUM('Active', 'Completed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_0487876286eddb65ed9143fc88" ON "pools" ("contract_pool_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5721b0a7eb71af11e8cea56b56" ON "pools" ("category") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_343a2f8668b32864c2c38cc0fd" ON "pools" ("creator_wallet") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_eeefb6d09bef12cc37ed0d2286" ON "pools" ("status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1dbe6587106d0e64c981d29324" ON "pools" ("created_at") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1dbe6587106d0e64c981d29324"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_eeefb6d09bef12cc37ed0d2286"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_343a2f8668b32864c2c38cc0fd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5721b0a7eb71af11e8cea56b56"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0487876286eddb65ed9143fc88"`,
    );
